...
//----------------------------------------------------------------//
//---------------- WeightVector Public Methods ----------------//
//----------------------------------------------------------------//

WeightVector::WeightVector(int dimensionality) 
  : scale_(1.0),
    squared_norm_(0.0),
...
WeightVector::WeightVector(const string& weight_vector_string) 
  : scale_(1.0),
    squared_norm_(0.0),
    dimensions_(0) {
...
WeightVector::WeightVector(const WeightVector& weight_vector) {
...
float WeightVector::InnerProduct(const SparseVector& x,
				    float x_scale) const {
...
float WeightVector::InnerProductOnDifference(const SparseVector& a,
...
void WeightVector::AddVector(const SparseVector& x, float x_scale) {
...
void WeightVector::ScaleBy(double scaling_factor) {
...
float WeightVector::ValueOf(int index) const {
  if (index < 0) {
...
void WeightVector::ProjectToL1Ball(float lambda, float epsilon) {
  // Re-scale lambda.
...
void WeightVector::ProjectToL1Ball(float lambda) {
  // Bail out early if possible.
  float current_l1 = 0.0;
  for (int i = 0; i < dimensions_; ++i) {
