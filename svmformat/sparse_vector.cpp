...
SparseVector::SparseVector(const char* in_string)
    : y_(0.0),
      a_(0.0),
      squared_norm_(0.0),
      group_id_("") {
...
SparseVector::SparseVector(const SparseVector& a,
...
string SparseVector::AsString() const {
...
void SparseVector::PushPair(int id, float value) {
...
//----------------------------------------------------------------//
//--------------- SparseVector Private Methods ----------------//
//----------------------------------------------------------------//

void SparseVector::DieFormat(const string& reason) {
    std::cerr << "Wrong format for input data:\n  " << reason << std::endl;
    exit(1);
}

void SparseVector::Init(const char* in_string) {
